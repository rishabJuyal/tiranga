...
import "./PusphpaRani.css";

export default function UnityGame() {
    const { unityProvider, sendMessage, isLoaded } = useUnityContext({
        loaderUrl: "/PushpaRani/Build//PushpaRani.loader.js",
        dataUrl: "/PushpaRani/Build//PushpaRani.data",
        frameworkUrl: "/PushpaRani/Build//PushpaRani.framework.js",
        codeUrl: "/PushpaRani/Build//PushpaRani.wasm",
      });
